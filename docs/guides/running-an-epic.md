...
4. Do not use the epic to sequence. The ranking procedure applies eligibility and same-lane dependencies before the plan's preferences. The full ID resolves the final tie. Epic membership contributes nothing. A prerequisite from outside the epic appears in the plan, marked by what it serves. It is part of the work and not an intrusion.
