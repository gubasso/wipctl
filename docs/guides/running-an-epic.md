...
4. Do not use the epic to sequence. The record's key chain orders entries from eligibility, same-lane dependencies, class of service, points, and the residual id. Epic membership contributes nothing. A prerequisite from outside the epic appears in the plan, marked by what it serves. It is part of the work and not an intrusion.
