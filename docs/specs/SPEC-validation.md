...
Four instance schemas gate what a project writes, and eight output schemas gate what verbs emit. A verb relaying a record fact in its own voice carries the command prefix, which is the ordinary stream discipline.
