...
Three instance schemas gate what a project writes, and seven output schemas gate what verbs emit. A verb relaying a record fact in its own voice carries the command prefix, which is the ordinary stream discipline.
