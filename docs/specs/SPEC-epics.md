...
The resolution MUST order entries topologically, break ties with the record's ranking procedure, and partition them into eligible and blocked groups while keeping that order.
