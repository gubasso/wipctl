...
- The command surface: [SPEC-cli-conventions.md](./specs/SPEC-cli-conventions.md), [SPEC-plan-targeting.md](./specs/SPEC-plan-targeting.md), [SPEC-messages.md](./specs/SPEC-messages.md), [SPEC-transactions.md](./specs/SPEC-transactions.md), [SPEC-manual.md](./specs/SPEC-manual.md).
