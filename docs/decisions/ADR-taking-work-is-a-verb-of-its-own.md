# Taking work is a verb of its own; next stays read-only
...
- Good: agents fan out onto different entries without negotiating, and the pairing rule of ADR-one-verb-resolves-one-epic-and-another-summarises-them-all covers the twins.
