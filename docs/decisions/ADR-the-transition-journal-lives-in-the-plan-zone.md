# The transition journal lives in the plan zone
...
- Bad: journal merge behaviour needs its own design, which ADR-a-transition-journal-is-one-stream-per-entry settles.
