# A transition commit is generated and opt-in
...
Superseded by ADR-a-plan-mutation-is-always-committed — a plan mutation is always committed, in the plan trunk's grammar.
