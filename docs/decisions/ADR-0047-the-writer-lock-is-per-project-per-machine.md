# ADR-0047: The writer lock is per project per machine and protects a transaction
...
- Good: the same guarantee ADR-0025 gave one checkout now spans the machine, and contention is measured in milliseconds.
