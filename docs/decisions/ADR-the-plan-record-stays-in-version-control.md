# The plan record stays in version control
...
Superseded by ADR-the-plan-record-lives-in-its-own-repository — the plan record lives in its own per-project repository.
