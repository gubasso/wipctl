...
- Leave ADR-0033 stated and unchecked.
...
- Good: ADR-0033's doctrine fails a test rather than a reading when it breaks.
- Good: the borrowed id grammar of ADR-0041 stays a shared convention rather than an adopted method.
