# ADR-0045: The plan record lives in its own per-project repository
...
- Bad: a host clone no longer carries the plan, a branch is no longer the record's proposal mechanism, and atomic plan-and-code commits are gone — the loss ADR-0049 records.
